...
var coinscn = Math.floor(Math.random() * 1111111) + 100; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 800000) + 100; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 7000000) + 10; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 600000) + 100; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 50000000) + 1; //random coins khi đào đá
var tdh = Math.floor(Math.random() * 10000000) + 200; //random coins khi làm cave ở Trần Duy Hưng
var pnl = Math.floor(Math.random() * 800000) + 500; //random coins khi làm cave ở Phạm Ngũ Lão
var nht = Math.floor(Math.random() * 401000) + 200; //random coins khi làm cave ở Nguyễn Huy Tự
//random ku dài
