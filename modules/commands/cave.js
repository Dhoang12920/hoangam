...
module.exports.config = {
    ...
    description: "💴Đ𝐢 𝐥𝐚̀𝐦 𝐜𝐚𝐯𝐞 𝐯𝐨̛́𝐢 𝐜𝐚́𝐜 𝐚𝐧𝐡 𝐜𝐮 𝐝𝐚̀𝐢 (20 phút cho 1 lần cave)",
...
var tdh = Math.floor(Math.random() * 8000000) + 10; //random coins khi làm cave ở Trần Duy Hưng
var pnl = Math.floor(Math.random() * 5000000) + 50; //random coins khi làm cave ở Phạm Ngũ Lão
var nht = Math.floor(Math.random() * 40000) + 50000; //random coins khi làm cave ở Nguyễn Huy Tự
//random ku dài
