...
module.exports.handleEvent = async ({ api, event, Users }) => {
    ...
    const morning = [
        `Chào buổi sáng ${userName}, mình là bot của Dhoang, mình có thể giúp gì được cho bạn?`,
        `Chào ${userName}, chúc bạn buổi sáng vui vẻ!`
    ];

    const afternoon = [
      `Chào buổi trưa ${userName}, mình là bot của Dhoang, mình có thể giúp gì được cho bạn?`,
        `Chào ${userName}, chúc bạn buổi trưa vui vẻ!`
    ];

    const evening = [
      `Chào buổi chiều ${userName}, mình là bot của Dhoang, mình có thể giúp gì được cho bạn?`,
        `Chào ${userName}, chúc bạn buổi chiều vui vẻ!`
    ];

    const night = [
        `Chào buổi tối ${userName}, mình là bot của Dhoang, mình có thể giúp gì được cho bạn?`,
